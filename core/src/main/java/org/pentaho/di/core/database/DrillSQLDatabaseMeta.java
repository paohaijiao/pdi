...
public class DrillSQLDatabaseMeta extends BaseDatabaseMeta implements DatabaseInterface {
    ...
    public String getURL( String hostname, String port, String databaseName ) {
            return "jdbc:drill:zk=" + hostname + ":" + port +"/"+databaseName;
    }
    @Override
    ...
    public String[] getUsedLibraries() {
        return new String[] { "hive-jdbc-1.1.0-cdh5.14.0" };
    }
    /**
